...
(function (global) {
  ...
  var T = {
    ...
    /* --- Davomat: dars holati --- */
    'Hozirgi va kelayotgan darslar': ['Текущие и предстоящие занятия', 'Current and upcoming lessons', 'الدروس الجارية والقادمة'],
    'Tugagan darslar': ['Завершённые занятия', 'Finished lessons', 'الدروس المنتهية'],
    'Hozir ketyapti': ['Идёт сейчас', 'In progress now', 'جارٍ الآن'],
    /* --- Izohlar (sayt + sozlamalar) 2026-09-23 --- */
    'Saytda turibdi': ['Опубликовано на сайте', 'Live on the site', 'منشور في الموقع'],
    'O’quvchilarimiz nima deydi': ['Что говорят наши ученики', 'What our students say', 'ماذا يقول طلّابنا'],
    'Izoh qoldirish': ['Оставить отзыв', 'Leave a review', 'اكتب رأيك'],
    'Izohlar': ['Отзывы', 'Reviews', 'الآراء'],
    'Izohlarni o’quvchilarning o’zi yozadi. Markaz ko’rib chiqqach saytda chiqadi.': ['Отзывы пишут сами ученики. После проверки центром они появляются на сайте.', 'The reviews are written by the students themselves and appear on the site once the centre has checked them.', 'يكتب الآراءَ الطلّابُ أنفسهم، وتظهر في الموقع بعد مراجعة المركز.'],
    'Hozircha izoh yo’q — birinchi bo’lib siz yozing.': ['Отзывов пока нет — напишите первым.', 'No reviews yet — be the first to write one.', 'لا آراء بعد — كن أوّل من يكتب.'],
    'Qaysi guruhdasiz (ixtiyoriy)': ['В какой вы группе (необязательно)', 'Which group are you in (optional)', 'في أيّ مجموعة أنت (اختياري)'],
    'Bahoyingiz': ['Ваша оценка', 'Your rating', 'تقييمك'],
    'Izohingiz': ['Ваш отзыв', 'Your review', 'رأيك'],
    'Izohingiz markaz ko’rib chiqqandan keyin saytda chiqadi.': ['Ваш отзыв появится на сайте после проверки центром.', 'Your review appears on the site after the centre has checked it.', 'يظهر رأيك في الموقع بعد مراجعة المركز.'],
    'Izohni biroz to’liqroq yozing.': ['Напишите отзыв чуть подробнее.', 'Please write the review in a little more detail.', 'اكتب رأيك بشيء من التفصيل.'],
    'Rahmat! Izohingiz markazga yuborildi.': ['Спасибо! Ваш отзыв отправлен в центр.', 'Thank you! Your review has been sent to the centre.', 'شكراً! أُرسل رأيك إلى المركز.'],
    'Masalan: Zubayr': ['Например: Зубайр', 'For example: Zubayr', 'مثال: زبير'],
    'Masalan: B1 guruhi': ['Например: группа B1', 'For example: group B1', 'مثال: مجموعة B1'],
    'Darslar qanday o’tyapti, nima yoqdi?': ['Как проходят занятия, что понравилось?', 'How are the lessons going, what did you like?', 'كيف تجري الدروس وما الذي أعجبك؟'],
    'Saytdagi izohlar': ['Отзывы на сайте', 'Reviews on the website', 'الآراء في الموقع'],
    'Izohni o’quvchilarning o’zi saytdan yozadi. Siz tasdiqlamaguningizcha saytda ko’rinmaydi. Tepadagi yuradigan tasma kamida 3 ta izoh bo’lganda paydo bo’ladi.': ['Отзыв пишет сам ученик на сайте. Пока вы его не подтвердите, на сайте он не виден. Бегущая лента вверху появляется, когда отзывов не меньше трёх.', 'Students write the reviews on the website themselves. A review stays hidden until you approve it, and the moving ribbon at the top appears once there are at least three.', 'يكتب الطالب رأيه من الموقع بنفسه، ولا يظهر حتى تعتمده أنت. ويظهر الشريط المتحرّك في الأعلى إذا بلغت الآراء ثلاثة فأكثر.'],
    'Yangi izoh yo’q.': ['Новых отзывов нет.', 'No new reviews.', 'لا آراء جديدة.'],
    'Saytda hozircha izoh yo’q.': ['На сайте пока нет отзывов.', 'There are no reviews on the site yet.', 'لا توجد آراء في الموقع بعد.'],
    'Saytga chiqarish': ['Опубликовать на сайте', 'Publish on the site', 'انشر في الموقع'],
    'Saytdan olish': ['Убрать с сайта', 'Remove from the site', 'أزِل من الموقع'],
    'Izohni o’chirish': ['Удалить отзыв', 'Delete the review', 'حذف الرأي'],
    'Bu izoh butunlay o’chiriladi.': ['Этот отзыв будет удалён окончательно.', 'This review will be deleted for good.', 'سيُحذف هذا الرأي نهائياً.'],
    'Izoh saytga chiqarildi': ['Отзыв опубликован на сайте', 'The review was published on the site', 'نُشر الرأي في الموقع'],
    'Izoh saytdan olindi': ['Отзыв убран с сайта', 'The review was removed from the site', 'أُزيل الرأي من الموقع'],
    'Izoh o’chirildi': ['Отзыв удалён', 'The review was deleted', 'حُذف الرأي'],
    '@albayan.cairo yoki havola': ['@albayan.cairo или ссылка', '@albayan.cairo or a link', '‏@albayan.cairo أو رابط'],
    '@albayan yoki havola': ['@albayan или ссылка', '@albayan or a link', '‏@albayan أو رابط'],
    'masalan: Taxtapul filiali': ['например: филиал Тахтапуль', 'for example: Taxtapul branch', 'مثال: فرع تخته‌پل'],
    'masalan: Misr metodikasi': ['например: египетская методика', 'for example: the Egyptian method', 'مثال: المنهج المصري'],
    ...
    'Bitta dastur — olti daraja': ['Одна программа — шесть уровней', 'One programme, six levels', 'برنامج واحد — ستة مستويات'],
    'Guruhlar darajasi bilan farq qiladi, narx esa hamma daraja uchun bir xil. Qaysi darajadan boshlashni bepul daraja testi aniqlaydi.': ['Группы отличаются уровнем, а цена одинакова для всех уровней. С какого уровня начать — покажет бесплатный тест.', 'Groups differ by level, but the price is the same for every level. A free placement test shows where to start.', 'تختلف المجموعات بالمستوى، أمّا السعر فواحد لكلّ المستويات. واختبار تحديد المستوى المجاني يبيّن من أين تبدأ.'],
    'Shu darajadan boshlash': ['Начать с этого уровня', 'Start at this level', 'ابدأ من هذا المستوى'],
    'Darajalar ro’yxati tez orada.': ['Список уровней появится скоро.', 'The list of levels is coming soon.', 'قائمة المستويات قريباً.'],
    'Oylik to’lov': ['Оплата за месяц', 'Monthly fee', 'الرسوم الشهرية'],
    'Narx daraja bilan o’zgarmaydi — A1 ham, C2 ham bir xil.': ['Цена не меняется с уровнем — и A1, и C2 одинаково.', 'The price does not change with the level: A1 and C2 cost the same.', 'السعر لا يتغيّر بتغيّر المستوى — A1 وC2 سواء.'],
    'Guruhga yozilish': ['Записаться в группу', 'Join a group', 'التسجيل في المجموعة'],
    'Narxni telefon orqali aytamiz': ['Цену сообщим по телефону', 'We will tell you the price by phone', 'نخبرك بالسعر عبر الهاتف'],
    'Narx haqida ma’lumot tez orada. Ariza qoldiring — o’zimiz bog’lanamiz.': ['Информация о цене появится скоро. Оставьте заявку — мы свяжемся с вами.', 'Price details are coming soon. Leave a request and we will call you.', 'تفاصيل السعر قريباً. اترك طلبك وسنتّصل بك.'],
    'Nega biz': ['Почему мы', 'Why us', 'لماذا نحن'],
    'Biz til o’rgatamiz — imtihon uchun emas, gapirish uchun': ['Мы учим языку — не ради экзамена, а чтобы говорить', 'We teach the language for speaking, not for an exam', 'نعلّم اللغة للتحدّث، لا للامتحان فقط'],
    'Har bir daraja aniq maqsad bilan tuzilgan: alifbodan boshlab erkin suhbatgacha. Darslar amaliy — o’quvchi birinchi kundan gapira boshlaydi.': ['Каждый уровень составлен с чёткой целью: от алфавита до свободной речи. Занятия практические — ученик говорит с первого дня.', 'Every level has a clear goal, from the alphabet to free conversation. Lessons are practical: students speak from day one.', 'كلّ مستوى له هدف واضح: من الحروف إلى الحوار الحرّ. الدروس عمليّة — يتكلّم الطالب من اليوم الأول.'],
    'Bir dastur, olti daraja — sakrab o’tish yo’q': ['Одна программа, шесть уровней — без перескоков', 'One programme, six levels — no skipping', 'برنامج واحد وستة مستويات — بلا قفز'],
    'Kichik guruh: har bir o’quvchiga vaqt yetadi': ['Малая группа: времени хватает каждому ученику', 'Small groups: there is time for every student', 'مجموعات صغيرة: يكفي الوقت لكلّ طالب'],
    'Misrda tahsil olgan ustozlar': ['Преподаватели, учившиеся в Египте', 'Teachers who studied in Egypt', 'أساتذة درسوا في مصر'],
    'Har dars davomat — ota-ona kabinetdan ko’rib turadi': ['Посещаемость на каждом уроке — родители видят её в кабинете', 'Attendance every lesson — parents see it in the cabinet', 'الحضور في كلّ درس — ويراه الوالدان في الصفحة الشخصية'],
    'Uy vazifasi va natija kabinetda saqlanadi': ['Домашние задания и результаты хранятся в кабинете', 'Homework and results are kept in the cabinet', 'الواجبات والنتائج محفوظة في الصفحة الشخصية'],
    'Ustozlar bilan tanishing': ['Познакомьтесь с преподавателями', 'Meet the teachers', 'تعرّف على الأساتذة'],
    'to’liq dastur': ['полная программа', 'full programme', 'المنهج كاملاً'],
    'Bir dars kelib ko’ring — guruhni, ustozni va dastur uslubini o’zingiz ko’rasiz.': ['Придите на один урок — сами увидите группу, преподавателя и стиль программы.', 'Come to one lesson and see the group, the teacher and how we teach.', 'احضر درساً واحداً — ترى المجموعة والأستاذ وأسلوب المنهج بنفسك.'],
    'Ariza qoldirish': ['Оставить заявку', 'Leave a request', 'اترك طلباً'],
    'har bir dars': ['каждый урок', 'each lesson', 'كلّ درس'],
    'Ishonch qatori (ixtiyoriy)': ['Строка доверия (необязательно)', 'Trust line (optional)', 'سطر الثقة (اختياري)'],
    'Hero tugmalari ostida kichik qator bo’lib chiqadi. Bo’sh qoldirsangiz ko’rinmaydi. Sonini o’zingiz bilgan haqiqiy songa qarab yozing — dastur uni bazadan sanab chiqarmaydi.': ['Появится небольшой строкой под кнопками в шапке. Оставите пустым — не будет видно. Число пишите по реальным данным, которые знаете сами: программа не считает его из базы.', 'Appears as a small line under the hero buttons. Leave it empty and it is hidden. Write a number you know to be true: the app does not count it from the database.', 'يظهر سطراً صغيراً تحت أزرار الواجهة. إن تركته فارغاً فلن يظهر. اكتب رقماً تعرف صحّته — فالبرنامج لا يحسبه من قاعدة البيانات.'],
    'masalan: 500+ o’quvchi bizni tanladi': ['например: 500+ учеников выбрали нас', 'e.g. 500+ students chose us', 'مثال: اختارنا أكثر من 500 طالب'],
    'Ko’pi bilan 60 belgi.': ['Не более 60 символов.', 'At most 60 characters.', 'بحد أقصى 60 حرفاً.'],
    'Olib tashlash': ['Убрать', 'Remove', 'إزالة'],
    'Boshlang’ich': ['Начальный', 'Beginner', 'مبتدئ'],
    'O’rta': ['Средний', 'Intermediate', 'متوسط'],
    'O’rtadan yuqori': ['Выше среднего', 'Upper-intermediate', 'فوق المتوسط'],
    'Yuqori': ['Продвинутый', 'Advanced', 'متقدم'],
    'Mukammal': ['Совершенный', 'Proficient', 'إتقان'],
    'Harflar, salomlashish, oddiy so’zlar.': ['Буквы, приветствия, простые слова.', 'Letters, greetings, simple words.', 'الحروف والتحيّات والكلمات البسيطة.'],
    'Kundalik gaplar, oddiy o’tgan zamon.': ['Повседневные фразы, простое прошедшее время.', 'Everyday phrases, the simple past.', 'جمل الحياة اليومية والماضي البسيط.'],
    'Suhbat, matn o’qish, fe’l shakllari.': ['Разговор, чтение текста, формы глагола.', 'Conversation, reading, verb forms.', 'الحوار وقراءة النصوص وصيغ الأفعال.'],
    'Erkin suhbat, matn tahlili.': ['Свободная речь, анализ текста.', 'Free conversation, text analysis.', 'الحوار الحرّ وتحليل النصوص.'],
    'Ilmiy matn, nozik ma’no farqlari.': ['Научный текст, тонкие смысловые различия.', 'Academic texts, fine shades of meaning.', 'النصوص العلمية والفروق الدقيقة في المعنى.'],
    'Adabiy matn, balog’at va sarf-nahv.': ['Литературный текст, риторика и грамматика.', 'Literary texts, rhetoric and grammar.', 'النصوص الأدبية والبلاغة والنحو والصرف.'],
    /* --- Ochiq sayt --- */
    ...
    /* --- O'quv qismi: dastur, dars jarayoni, testlar, ota-ona --- */
    'O’quv dasturi': ['Учебная программа', 'Curriculum', 'المنهج الدراسي'],
    'Daraja → modul → dars → material va vazifa': ['Уровень → модуль → урок → материал и задание', 'Level → module → lesson → material and homework', 'المستوى ← الوحدة ← الدرس ← المادة والواجب'],
    'Dars jarayoni': ['Ход урока', 'Lesson flow', 'سير الدرس'],
    'Dars yozuvi, testlar, savollar va fikrlar': ['Запись урока, тесты, вопросы и отзывы', 'Lesson log, quizzes, questions and feedback', 'سجل الدرس والاختبارات والأسئلة والآراء'],
    'O’quv natijalari': ['Учебные результаты', 'Learning results', 'النتائج الدراسية'],
    'Davomat, testlar va uy vazifasi': ['Посещаемость, тесты и домашнее задание', 'Attendance, quizzes and homework', 'الحضور والاختبارات والواجب'],
    'Bayram va tanaffus': ['Праздники и перерывы', 'Holidays and pauses', 'العطلات والاستراحات'],
    'Dars bo’lmaydigan kunlar': ['Дни без занятий', 'Days without lessons', 'أيام بلا دروس'],
    'Ota-onalar': ['Родители', 'Parents', 'أولياء الأمور'],
    'Modul qo’shish': ['Добавить модуль', 'Add module', 'إضافة وحدة'],
    'Modul nomi': ['Название модуля', 'Module name', 'اسم الوحدة'],
    'Modulni tahrirlash': ['Редактировать модуль', 'Edit module', 'تعديل الوحدة'],
    'Modulni o’chirish': ['Удалить модуль', 'Delete module', 'حذف الوحدة'],
    'Modul saqlandi.': ['Модуль сохранён.', 'Module saved.', 'تم حفظ الوحدة.'],
    'Yangi modul': ['Новый модуль', 'New module', 'وحدة جديدة'],
    'Yangi modul qo’shing.': ['Добавьте новый модуль.', 'Add a new module.', 'أضف وحدة جديدة.'],
    'Bu darajada modul yo’q': ['На этом уровне нет модулей', 'No modules at this level', 'لا توجد وحدات في هذا المستوى'],
    'Administrator modul qo’shishi kerak.': ['Модуль должен добавить администратор.', 'An administrator must add a module.', 'يجب على المسؤول إضافة وحدة.'],
    'Dasturni yuklab bo’lmadi.': ['Не удалось загрузить программу.', 'Could not load the curriculum.', 'تعذّر تحميل المنهج.'],
    'Soat (taxminiy)': ['Часы (примерно)', 'Hours (approx.)', 'الساعات (تقريباً)'],
    'Dars qo’shish': ['Добавить урок', 'Add lesson', 'إضافة درس'],
    'Dars mavzusi': ['Тема урока', 'Lesson topic', 'موضوع الدرس'],
    'Darsni tahrirlash': ['Редактировать урок', 'Edit lesson', 'تعديل الدرس'],
    'Darsni o’chirish': ['Удалить урок', 'Delete lesson', 'حذف الدرس'],
    'Dars saqlandi.': ['Урок сохранён.', 'Lesson saved.', 'تم حفظ الدرس.'],
    'Yangi dars': ['Новый урок', 'New lesson', 'درس جديد'],
    'Darslar qo’shilmagan.': ['Уроки не добавлены.', 'No lessons added.', 'لم تُضف دروس.'],
    '(nomsiz dars)': ['(урок без названия)', '(unnamed lesson)', '(درس بلا اسم)'],
    'Maqsad (nimani o’rganadi)': ['Цель (что изучается)', 'Goal (what is learned)', 'الهدف (ما الذي يتعلمه)'],
    'Materiallar': ['Материалы', 'Materials', 'المواد'],
    'Material': ['Материал', 'Material', 'مادة'],
    'Material nomi': ['Название материала', 'Material name', 'اسم المادة'],
    'Material qo’shish': ['Добавить материал', 'Add material', 'إضافة مادة'],
    'Material qo’shilmagan.': ['Материалы не добавлены.', 'No materials added.', 'لم تُضف مواد.'],
    'Yangi material': ['Новый материал', 'New material', 'مادة جديدة'],
    'Uy vazifalari': ['Домашние задания', 'Homework', 'الواجبات المنزلية'],
    'Uy vazifasi': ['Домашнее задание', 'Homework', 'الواجب المنزلي'],
    'Vazifa nomi': ['Название задания', 'Homework name', 'اسم الواجب'],
    'Vazifa qo’shish': ['Добавить задание', 'Add homework', 'إضافة واجب'],
    'Vazifa qo’shilmagan.': ['Задания не добавлены.', 'No homework added.', 'لم تُضف واجبات.'],
    'Vazifa muddati': ['Срок задания', 'Homework due date', 'موعد تسليم الواجب'],
    'Havola (ixtiyoriy)': ['Ссылка (необязательно)', 'Link (optional)', 'رابط (اختياري)'],
    'Fayl (ixtiyoriy)': ['Файл (необязательно)', 'File (optional)', 'ملف (اختياري)'],
    'Fayl tanlash': ['Выбрать файл', 'Choose file', 'اختيار ملف'],
    'Fayl tanlanmagan': ['Файл не выбран', 'No file selected', 'لم يتم اختيار ملف'],
    'Fayl 10 MB dan katta.': ['Файл больше 10 МБ.', 'The file is larger than 10 MB.', 'الملف أكبر من ١٠ ميغابايت.'],
    'Faylni ochish': ['Открыть файл', 'Open file', 'فتح الملف'],
    'Yuklanmadi': ['Не загружено', 'Not uploaded', 'لم يُرفع'],
    'Yuklab bo’lmadi.': ['Не удалось загрузить.', 'Could not load.', 'تعذّر التحميل.'],
    'Xato yuz berdi.': ['Произошла ошибка.', 'An error occurred.', 'حدث خطأ.'],
    'Dars yozuvi': ['Запись урока', 'Lesson log', 'سجل الدرس'],
    'Dars yozuvi yo’q': ['Записей урока нет', 'No lesson logs', 'لا توجد سجلات دروس'],
    'Dars yozuvini tahrirlash': ['Редактировать запись урока', 'Edit lesson log', 'تعديل سجل الدرس'],
    'Dars yozuvi saqlandi.': ['Запись урока сохранена.', 'Lesson log saved.', 'تم حفظ سجل الدرس.'],
    'Darsda nima bo’ldi': ['Что было на уроке', 'What happened in the lesson', 'ماذا جرى في الدرس'],
    'Testlar': ['Тесты', 'Quizzes', 'الاختبارات'],
    'Test yo’q': ['Тестов нет', 'No quizzes', 'لا توجد اختبارات'],
    'Test tuzish': ['Создать тест', 'Create quiz', 'إنشاء اختبار'],
    'Test nomi': ['Название теста', 'Quiz name', 'اسم الاختبار'],
    'Yangi test': ['Новый тест', 'New quiz', 'اختبار جديد'],
    'Test saqlandi.': ['Тест сохранён.', 'Quiz saved.', 'تم حفظ الاختبار.'],
    'Testni o’chirish': ['Удалить тест', 'Delete quiz', 'حذف الاختبار'],
    'Test o’rtachasi': ['Средний балл теста', 'Quiz average', 'متوسط الاختبار'],
    'Testdan o’tish': ['Прохождение теста', 'Quiz pass rate', 'اجتياز الاختبار'],
    'O’tish foizi': ['Проходной процент', 'Pass percentage', 'نسبة النجاح'],
    'Savol matni': ['Текст вопроса', 'Question text', 'نص السؤال'],
    'Savol qo’shish': ['Добавить вопрос', 'Add question', 'إضافة سؤال'],
    'To’g’ri javob': ['Правильный ответ', 'Correct answer', 'الإجابة الصحيحة'],
    'Kamida bitta to’liq savol kerak.': ['Нужен хотя бы один полный вопрос.', 'At least one complete question is required.', 'مطلوب سؤال كامل واحد على الأقل.'],
    'Savol-javob': ['Вопрос-ответ', 'Questions and answers', 'سؤال وجواب'],
    'Savol yo’q': ['Вопросов нет', 'No questions', 'لا توجد أسئلة'],
    'Savolga javob': ['Ответ на вопрос', 'Answer the question', 'الرد على السؤال'],
    'Javob yozish': ['Написать ответ', 'Write an answer', 'كتابة رد'],
    'Javob': ['Ответ', 'Answer', 'الرد'],
    'Javob yuborildi.': ['Ответ отправлен.', 'Answer sent.', 'تم إرسال الرد.'],
    'Fikrlar': ['Отзывы', 'Feedback', 'الآراء'],
    'Fikr': ['Отзыв', 'Feedback', 'رأي'],
    'Umumiy baho': ['Общая оценка', 'Overall rating', 'التقييم العام'],
    'Oxirgi fikrlar': ['Последние отзывы', 'Latest feedback', 'أحدث الآراء'],
    'Anonim': ['Аноним', 'Anonymous', 'مجهول'],
    'Qo’shimcha dars': ['Дополнительный урок', 'Make-up lesson', 'درس تعويضي'],
    'Qo’shimcha dars yo’q': ['Дополнительных уроков нет', 'No make-up lessons', 'لا توجد دروس تعويضية'],
    'Qo’shimcha dars sanasi': ['Дата дополнительного урока', 'Make-up lesson date', 'تاريخ الدرس التعويضي'],
    'Qoldirgan dars sanasi': ['Дата пропущенного урока', 'Missed lesson date', 'تاريخ الدرس الفائت'],
    'Faqat davomatda «kelmadi» yoki «sababli» deb belgilangan dars uchun beriladi.': ['Назначается только для урока, отмеченного как «не пришёл» или «по уважительной причине».', 'Only available for a lesson marked as absent or excused in the attendance.', 'يُمنح فقط لدرس مسجَّل في الحضور بـ«غائب» أو «بعذر».'],
    'Belgilash': ['Назначить', 'Schedule', 'تحديد'],
    'Belgilandi.': ['Назначено.', 'Scheduled.', 'تم التحديد.'],
    'Belgilangan dars': ['Отмеченные уроки', 'Marked lessons', 'الدروس المسجّلة'],
    'Guruhda o’quvchi yo’q.': ['В группе нет учеников.', 'The group has no students.', 'لا يوجد طلاب في المجموعة.'],
    'Dam olish kuni': ['Выходной день', 'Day off', 'يوم عطلة'],
    'Butun markaz': ['Весь центр', 'Whole centre', 'المركز كله'],
    'Bitta guruh': ['Одна группа', 'One group', 'مجموعة واحدة'],
    'Guruh (faqat guruh tanlansa)': ['Группа (только если выбрана группа)', 'Group (only if a group is chosen)', 'المجموعة (فقط عند اختيار مجموعة)'],
    'Tugash (bir kun bo’lsa bo’sh qoldiring)': ['Окончание (оставьте пустым, если один день)', 'End (leave empty for a single day)', 'النهاية (اتركه فارغاً ليوم واحد)'],
    'Yozuv yo’q': ['Записей нет', 'No records', 'لا توجد سجلات'],
    'Ota-ona qo’shish': ['Добавить родителя', 'Add parent', 'إضافة ولي أمر'],
    'Ota-onani tahrirlash': ['Редактировать родителя', 'Edit parent', 'تعديل ولي الأمر'],
    'Yangi ota-ona': ['Новый родитель', 'New parent', 'ولي أمر جديد'],
    'Farzandlari': ['Дети', 'Children', 'الأبناء'],
    'Ota': ['Отец', 'Father', 'الأب'],
    'Ona': ['Мать', 'Mother', 'الأم'],
    'Vasiy': ['Опекун', 'Guardian', 'الوصي'],
    'Hisob yo’q': ['Учётных записей нет', 'No accounts', 'لا توجد حسابات'],
    'Yangi kod': ['Новый код', 'New code', 'رمز جديد'],
    'Kabinet kodi. ': ['Код кабинета. ', 'Cabinet code. ', 'رمز الصفحة. '],
    'Ota-ona kabinetga O’Z kodi bilan kiradi va faqat farzandlarining ma’lumotini ko’radi.': ['Родитель входит в кабинет по СВОЕМУ коду и видит только данные своих детей.', 'A parent signs in with their OWN code and sees only their children\'s information.', 'يدخل ولي الأمر برمزه الخاص ويرى بيانات أبنائه فقط.'],
    'Eski kod ishlamay qoladi va ochiq kabinet yopiladi. Davom etamizmi?': ['Старый код перестанет работать, открытый кабинет закроется. Продолжаем?', 'The old code will stop working and any open cabinet will be closed. Continue?', 'سيتوقف الرمز القديم وتُغلق الصفحة المفتوحة. هل نتابع؟'],
    'Orqaga': ['Назад', 'Back', 'رجوع'],
    'Ustoz': ['Преподаватель', 'Teacher', 'المعلّم'],
    'Vaqti': ['Время', 'Time', 'الوقت'],
    'Ha, o’chirilsin': ['Да, удалить', 'Yes, delete', 'نعم، احذف'],
    'Yangilandi.': ['Обновлено.', 'Updated.', 'تم التحديث.'],
    'o’chirilgan': ['удалено', 'deleted', 'محذوف'],
    '» o’chirilsinmi?': ['» удалить?', '» — delete it?', '» هل يُحذف؟'],
    '» o’chadi. Natijalar qoladi. Davom etamizmi?': ['» будет удалён. Результаты останутся. Продолжаем?', '» will be deleted. The results remain. Continue?', '» سيُحذف. تبقى النتائج. هل نتابع؟'],
    '» va uning ichidagi barcha yozuvlar o’chadi. Davom etamizmi?': ['» и все записи внутри будут удалены. Продолжаем?', '» and everything inside it will be deleted. Continue?', '» وكل ما بداخله سيُحذف. هل نتابع؟'],
    ' material · ': [' материалов · ', ' materials · ', ' مادة · '],
    ' savol · ': [' вопросов · ', ' questions · ', ' سؤالاً · '],
    ' · o’rtacha ': [' · в среднем ', ' · average ', ' · بالمتوسط '],
    'Dasturni ko’rish': ['Просмотр программы', 'View the curriculum', 'عرض المنهج'],
    'Modul, dars va material tahriri': ['Редактирование модулей, уроков и материалов', 'Edit modules, lessons and materials', 'تعديل الوحدات والدروس والمواد'],
    'Dars yozuvi va uy vazifasi': ['Запись урока и домашнее задание', 'Lesson log and homework', 'سجل الدرس والواجب'],
    'Dars testlari va savollar': ['Тесты урока и вопросы', 'Lesson quizzes and questions', 'اختبارات الدرس والأسئلة'],
    'O’quvchi savoliga javob berish': ['Ответы на вопросы учеников', 'Answer student questions', 'الرد على أسئلة الطلاب'],
    'Fikrlarni ko’rish': ['Просмотр отзывов', 'View feedback', 'عرض الآراء'],
    'Qo’shimcha dars belgilash': ['Назначение дополнительных уроков', 'Schedule make-up lessons', 'تحديد الدروس التعويضية'],
    'Ota-ona hisobi': ['Учётная запись родителя', 'Parent account', 'حساب ولي الأمر'],
    'O’quv natijalari hisoboti': ['Отчёт по учебным результатам', 'Learning results report', 'تقرير النتائج الدراسية'],
    'Ota-ona kabineti': ['Кабинет родителя', 'Parent cabinet', 'صفحة ولي الأمر'],
    'Ustozga savol': ['Вопрос преподавателю', 'Ask the teacher', 'سؤال للمعلّم'],
    'Ustozga savol berish': ['Задать вопрос преподавателю', 'Ask the teacher a question', 'طرح سؤال على المعلّم'],
    'Savolingizni yozing': ['Напишите свой вопрос', 'Write your question', 'اكتب سؤالك'],
    'Savolni yozing.': ['Напишите вопрос.', 'Write the question.', 'اكتب السؤال.'],
    'Savol yuborildi.': ['Вопрос отправлен.', 'Question sent.', 'تم إرسال السؤال.'],
    'Javob kutilmoqda': ['Ожидает ответа', 'Awaiting an answer', 'بانتظار الرد'],
    'Testni ishlash': ['Пройти тест', 'Take the quiz', 'أداء الاختبار'],
    'Testni ochib bo’lmadi.': ['Не удалось открыть тест.', 'Could not open the quiz.', 'تعذّر فتح الاختبار.'],
    'Test topshirildi.': ['Тест сдан.', 'Quiz submitted.', 'تم تسليم الاختبار.'],
    'O’tish foiziga yetmadi.': ['Проходной процент не достигнут.', 'The pass mark was not reached.', 'لم تبلغ نسبة النجاح.'],
    'O’quv ma’lumoti yuklanmoqda…': ['Учебные данные загружаются…', 'Loading learning data…', 'جارٍ تحميل البيانات الدراسية…'],
    'Sizga hali farzand biriktirilmagan. Markazga murojaat qiling.': ['К вам пока не прикреплён ребёнок. Обратитесь в центр.', 'No child is linked to you yet. Please contact the centre.', 'لم يُربط بك ابن بعد. يرجى التواصل مع المركز.'],
    'Qayta topshirish': ['Пройти заново', 'Retake', 'إعادة المحاولة'],
    'Qoldirilgan dars: ': ['Пропущенный урок: ', 'Missed lesson: ', 'الدرس الفائت: '],

    /* --- Sayt va bot sozlamalari --- */
    'Shaxsiy kod — bot va kabinet uchun': ['Личный код — для бота и кабинета', 'Personal code — for the bot and the cabinet', 'الرمز الشخصي — للبوت والصفحة'],
    ...
    /* --- Saytdagi yozuv iboralari --- */
    'Saytda yozilib turadigan iboralar': ['Фразы, которые печатаются на сайте', 'Phrases typed out on the website', 'العبارات التي تُكتب في الموقع'],
    'Har qatorda bitta ibora. Saytda markaz nomi tagida navbat bilan harf-harf yozilib turadi. Ko’pi bilan 8 ta, har biri 90 belgigacha. Bo’sh qoldirsangiz standart iboralar chiqadi.': ['По одной фразе в строке. На сайте они по очереди печатаются под названием центра. Не более 8, каждая до 90 символов. Оставьте пустым — появятся стандартные.', 'One phrase per line. They are typed out in turn under the centre name. Up to 8, each up to 90 characters. Leave empty for the default phrases.', 'عبارة واحدة في كل سطر. تُكتب بالتتابع تحت اسم المركز. ٨ عبارات كحد أقصى، كل واحدة حتى ٩٠ حرفاً. اتركه فارغاً لتظهر العبارات الافتراضية.'],
    'Ko’pi bilan 8 ta ibora.': ['Не более 8 фраз.', 'At most 8 phrases.', '٨ عبارات كحد أقصى.'],

    /* --- Sayt: bosqichlar, ariza, savol-javob, sozlamalar --- */
    'Hero yorlig’i (ixtiyoriy)': ['Ярлык в шапке (необязательно)', 'Hero badge (optional)', 'شارة الواجهة (اختياري)'],
    'Saytning yuqori o’ng burchagida kichik yorliq bo’lib chiqadi. Bo’sh qoldirsangiz ko’rinmaydi. Faqat o’zingiz tasdiqlagan gapni yozing.': ['Появится маленьким ярлыком в правом верхнем углу сайта. Оставьте пустым — не будет показан. Пишите только то, что можете подтвердить.', 'Appears as a small badge in the top-right corner of the site. Leave empty to hide it. Write only what you can stand behind.', 'تظهر كشارة صغيرة في أعلى يمين الموقع. اتركها فارغة لإخفائها. اكتب ما يمكنك تأكيده فقط.'],
    'Ko’pi bilan 40 belgi.': ['Не более 40 символов.', 'At most 40 characters.', '٤٠ حرفاً كحد أقصى.'],
    'Saytdagi ko’rsatkichlar': ['Показатели на сайте', 'Site figures', 'أرقام الموقع'],
    'Har qatorda bitta ko’rsatkich: yirik yozuv, so’ng | belgisi, so’ng izoh. Ko’pi bilan 4 ta. Bo’sh qoldirsangiz standart uchtasi chiqadi.': ['По одному показателю в строке: крупное значение, затем знак |, затем пояснение. Не более 4. Оставьте пустым — появятся стандартные три.', 'One figure per line: the large value, then a | sign, then the caption. Up to 4. Leave empty for the default three.', 'رقم واحد في كل سطر: القيمة الكبيرة، ثم علامة |، ثم الوصف. ٤ كحد أقصى. اتركه فارغاً لتظهر الثلاثة الافتراضية.'],
    'Ko’pi bilan 4 ta ko’rsatkich.': ['Не более 4 показателей.', 'At most 4 figures.', '٤ أرقام كحد أقصى.'],
    'Birinchi qator — savol, keyingi qator — javob. Har bir juftlikni bo’sh qator bilan ajrating. Ko’pi bilan 10 ta. Bo’sh bo’lsa bo’lim ko’rinmaydi.': ['Первая строка — вопрос, следующая — ответ. Разделяйте пары пустой строкой. Не более 10. Если пусто, раздел не показывается.', 'The first line is the question, the next is the answer. Separate pairs with a blank line. Up to 10. If empty, the section is hidden.', 'السطر الأول سؤال والذي يليه جواب. افصل بين الأزواج بسطر فارغ. ١٠ كحد أقصى. إذا كان فارغاً لا يظهر القسم.'],
    'Ko’pi bilan 10 ta savol.': ['Не более 10 вопросов.', 'At most 10 questions.', '١٠ أسئلة كحد أقصى.'],
    'YouTube': ['YouTube', 'YouTube', 'يوتيوب'],
    'Savollar': ['Вопросы', 'Questions', 'الأسئلة'],
    'Nega aynan AlBayan Cairo?': ['Почему именно AlBayan Cairo?', 'Why AlBayan Cairo?', 'لماذا البيان القاهرة بالتحديد؟'],
    'Har bir bosqich aniq maqsad bilan tuzilgan: alifbodan boshlab erkin suhbatgacha. Darslar amaliy — o’quvchi birinchi kundan gapira boshlaydi.': ['Каждый уровень построен с конкретной целью: от алфавита до свободной беседы. Занятия практические — ученик начинает говорить с первого дня.', 'Every level is built around a clear goal: from the alphabet to free conversation. Lessons are practical — the student starts speaking from day one.', 'كل مستوى مبني على هدف واضح: من الحروف إلى المحادثة الحرة. الدروس عملية — يبدأ الطالب بالكلام من اليوم الأول.'],
    'Bosqichma-bosqich dastur': ['Пошаговая программа', 'A step-by-step programme', 'برنامج متدرّج'],
    'Alifbodan C2 gacha — har bosqich oldingisiga qurilgan, sakrab o’tish yo’q.': ['От алфавита до C2 — каждый уровень опирается на предыдущий, без пропусков.', 'From the alphabet to C2 — each level builds on the previous one, no skipping.', 'من الحروف إلى C2 — كل مستوى يبني على الذي قبله، دون تخطٍّ.'],
    'Bosqichma-bosqich til o’rganish tizimi': ['Пошаговая система изучения языка', 'A step-by-step system for learning the language', 'نظام متدرّج لتعلّم اللغة'],
    'Noldan boshlab erkin suhbatgacha — xalqaro CEFR darajalariga mos bosqichlar.': ['С нуля до свободной беседы — уровни по международной шкале CEFR.', 'From zero to free conversation — levels aligned with the international CEFR scale.', 'من الصفر إلى المحادثة الحرة — مستويات وفق المعيار الدولي CEFR.'],
    'Eng ko’p tanlangan': ['Выбирают чаще всего', 'Most chosen', 'الأكثر اختياراً'],
    'Ushbu guruhga yozilish': ['Записаться в эту группу', 'Join this group', 'التسجيل في هذه المجموعة'],
    'Batafsil': ['Подробнее', 'Details', 'التفاصيل'],
    'Darsni kim olib boradi': ['Кто ведёт занятия', 'Who teaches', 'من يقوم بالتدريس'],
    'Bepul sinov darsi': ['Бесплатный пробный урок', 'A free trial lesson', 'درس تجريبي مجاني'],
    'Darajangizni aniqlang va bepul sinov darsida qatnashing': ['Определите свой уровень и приходите на бесплатный пробный урок', 'Find your level and join a free trial lesson', 'حدّد مستواك واحضر درساً تجريبياً مجانياً'],
    'Qisqa suhbat va daraja testidan keyin sizga mos guruhni aytamiz.': ['После короткой беседы и теста мы подберём вам подходящую группу.', 'After a short talk and a level test we will tell you which group suits you.', 'بعد مقابلة قصيرة واختبار للمستوى نرشّح لك المجموعة المناسبة.'],
    'Qisqa suhbat — darajani aniqlash uchun': ['Короткая беседа — чтобы определить уровень', 'A short talk — to establish your level', 'مقابلة قصيرة — لتحديد المستوى'],
    'Bepul sinov darsi — guruhni ichidan ko’rasiz': ['Бесплатный пробный урок — увидите группу изнутри', 'A free trial lesson — you see the group from the inside', 'درس تجريبي مجاني — ترى المجموعة من الداخل'],
    'Mos guruh va jadval taklifi': ['Предложение подходящей группы и расписания', 'A suggested group and schedule', 'اقتراح المجموعة والجدول المناسبين'],
    'Ro’yxatdan o’tish formasi': ['Форма записи', 'Registration form', 'نموذج التسجيل'],
    'Ma’lumotlaringiz maxfiy, administratorimiz siz bilan bog’lanadi.': ['Ваши данные конфиденциальны, наш администратор свяжется с вами.', 'Your details stay private; our administrator will contact you.', 'بياناتك سرّية، وسيتواصل معك مسؤولنا.'],
    'Ism va familiyangiz': ['Ваше имя и фамилия', 'Your first and last name', 'اسمك ولقبك'],
    'Telefon raqamingiz': ['Ваш номер телефона', 'Your phone number', 'رقم هاتفك'],
    'Hozirgi arab tili darajangiz': ['Ваш текущий уровень арабского', 'Your current level of Arabic', 'مستواك الحالي في العربية'],
    'Noldan (alifbo)': ['С нуля (алфавит)', 'From zero (the alphabet)', 'من الصفر (الحروف)'],
    'O’qiy olaman': ['Умею читать', 'I can read', 'أستطيع القراءة'],
    'Grammatikani bilaman': ['Знаю грамматику', 'I know the grammar', 'أعرف القواعد'],
    'Dars uchun qulay vaqt': ['Удобное время занятий', 'A convenient lesson time', 'الوقت المناسب للدرس'],
    'Farqi yo’q': ['Не важно', 'No preference', 'لا يهم'],
    'Bepul sinov darsiga yozilish': ['Записаться на бесплатный урок', 'Sign up for the free lesson', 'التسجيل في الدرس المجاني'],
    'Tugmani bosish orqali siz shaxsiy ma’lumotlaringiz qayta ishlanishiga rozilik bildirasiz.': ['Нажимая кнопку, вы соглашаетесь на обработку своих персональных данных.', 'By pressing the button you agree to your personal data being processed.', 'بالضغط على الزر توافق على معالجة بياناتك الشخصية.'],
    'Tez-tez beriladigan savollar': ['Часто задаваемые вопросы', 'Frequently asked questions', 'الأسئلة الشائعة'],
    'Bo’limlar': ['Разделы', 'Sections', 'الأقسام'],
    'Bosqichlar va narx': ['Уровни и цены', 'Levels and prices', 'المستويات والأسعار'],
    'Ijtimoiy tarmoqlar': ['Социальные сети', 'Social networks', 'شبكات التواصل'],
    'Tez orada': ['Скоро', 'Coming soon', 'قريباً'],
    'Har kuni ': ['Каждый день ', 'Every day ', 'كل يوم '],
