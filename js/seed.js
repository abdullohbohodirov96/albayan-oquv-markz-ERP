...
(function (global) {
  ...
  async function demo() {
    ...
    // Kurslar
    var courses = [
      { id: 'crs_ing', name: 'Ingliz tili', description: 'Boshlang’ich va o’rta daraja', monthlyFee: 450000, lessonMinutes: 90, active: true, demo: true },
      { id: 'crs_mat', name: 'Matematika', description: 'Maktab dasturi va test', monthlyFee: 400000, lessonMinutes: 90, active: true, demo: true },
      { id: 'crs_it', name: 'Kompyuter savodxonligi', description: 'Office, internet, Canva', monthlyFee: 500000, lessonMinutes: 120, active: true, demo: true },
      { id: 'crs_kor', name: 'Koreys tili', description: 'TOPIK 1 ga tayyorlov', monthlyFee: 550000, lessonMinutes: 90, active: true, demo: true }
    ];
    ...
    var groups = [
      {
        id: 'grp_ing_a', name: 'Ingliz A1 (ertalab)', courseId: 'crs_ing', teacherId: 'stf_t1', roomId: 'room_1',
      ...
      {
        id: 'grp_ing_b', name: 'Ingliz B1 (kechqurun)', courseId: 'crs_ing', teacherId: 'stf_t2', roomId: 'room_2',
      ...
      {
        id: 'grp_mat', name: 'Matematika 9-sinf', courseId: 'crs_mat', teacherId: 'stf_t3', roomId: 'room_1',
      ...
      {
        id: 'grp_it', name: 'Kompyuter savodxonligi', courseId: 'crs_it', teacherId: 'stf_t1', roomId: 'room_3',
        days: [1, 4], startTime: '11:00', endTime: '13:00', startDate: '2026-09-01',
        fee: 500000, feeHistory: [{ fee: 500000, from: '2026-09' }], limit: 10, status: 'faol', demo: true
      },
      {
        id: 'grp_kor', name: 'Koreys tili boshlang’ich', courseId: 'crs_kor', teacherId: 'stf_t2', roomId: 'room_2',
        days: [1, 3], startTime: '15:00', endTime: '16:30', startDate: A.addMonths(ym, 1) + '-01',
        fee: 550000, feeHistory: [{ fee: 550000, from: A.addMonths(ym, 1) }], limit: 12, status: 'rejalashtirilgan', demo: true
      }
    ];
    ...
    // Murojaatlar
    var leads = [
      { id: 'led_1', name: 'Zilola Karimova', phone: '+998935551122', courseId: 'crs_ing', source: 'Instagram', ownerStaffId: 'stf_adm', stage: 'yangi', note: 'Kechki guruh qiziqtiradi', nextContact: today, createdAt: A.addDays(today, -1) + ' 10:00', demo: true },
      { id: 'led_2', name: 'Sardor Ubaydullayev', phone: '+998935551133', courseId: 'crs_it', source: 'Tanish orqali', ownerStaffId: 'stf_adm', stage: 'boglanildi', note: 'Narxni o’yladi', nextContact: A.addDays(today, 1), createdAt: A.addDays(today, -3) + ' 15:20', demo: true },
      { id: 'led_3', name: 'Nargiza Toirova', phone: '+998935551144', courseId: 'crs_kor', source: 'Telegram', ownerStaffId: 'stf_adm', stage: 'sinov', note: 'Shanba sinov darsi', nextContact: A.addDays(today, 2), createdAt: A.addDays(today, -5) + ' 12:00', demo: true },
      { id: 'led_4', name: 'Oybek Ergashev', phone: '+998935551155', courseId: 'crs_mat', source: 'Banner', ownerStaffId: 'stf_adm', stage: 'rad', note: 'Uzoq', nextContact: '', createdAt: A.addDays(today, -7) + ' 09:30', demo: true }
    ];
